...
if Modelo_precedencias_CON_PESO.status in [GRB.OPTIMAL, GRB.TIME_LIMIT]:
    ...
    mejor_limite_inferior = Modelo_precedencias_CON_PESO.ObjBound
    
    print("\n" + "="*40)
    print("RESULTADOS DE LA OPTIMIZACIÓN")
    print("="*40)
    print(f"Valor Objetivo (Z): {Modelo_precedencias_CON_PESO.objVal:.2f}")
    ...
    ax.set_title(f'Gantt: {ruta_archivo} | Obj: {Modelo_precedencias_CON_PESO.objVal:.2f} | Gap: {gap_actual:.2f}%')
...
elif Modelo_precedencias_CON_PESO.status == GRB.INFEASIBLE:
